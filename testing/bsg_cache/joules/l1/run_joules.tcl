#-------------------------------------------------------------------------------
# joules_l1.tcl — Cadence Joules power analysis for L1 Cache (64KB, 4-way, 256 sets)
#
# Usage:  joules -init joules_l1.tcl
#-------------------------------------------------------------------------------

set SCRIPT_DIR [file dirname [file normalize [info script]]]
source $SCRIPT_DIR/../common_setup.tcl

set design      bsg_cache_l1
set design_name l1
set STIM        $BSG_STL/testing/bsg_cache/power_l1/bsg_cache_l1_pwr.fsdb
