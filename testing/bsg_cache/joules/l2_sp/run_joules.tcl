#-------------------------------------------------------------------------------
# joules_l2_sp.tcl — Cadence Joules power analysis for L2 Cache+SPM (512KB, 8-way, 1024 sets, scratchpad)
#
# Usage:  joules -init joules_l2_sp.tcl
#-------------------------------------------------------------------------------

set SCRIPT_DIR [file dirname [file normalize [info script]]]
source $SCRIPT_DIR/../common_setup.tcl

set design      bsg_cache_l2_spm
set design_name l2_sp
set STIM        $BSG_STL/testing/bsg_cache/power_l2_sp/bsg_cache_l2_sp.fsdb
...
puts "joules_l2_sp.tcl completed."
exit
