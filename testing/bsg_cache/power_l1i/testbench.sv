/**
 *  testbench.sv - L1I Cache Power Evaluation
 *
 *  L1I: 64KB, 4-way, 64B cacheline, 256 sets
 *
 *  Phases:
...
module testbench();
  ...
  always_ff @(posedge clk) begin
    if (finish_r) begin
      $display("[BSG_FINISH] L1I power testbench complete. sent=%0d recv=%0d", send_cnt_r, recv_cnt_r);
      $finish;
    end
  end
